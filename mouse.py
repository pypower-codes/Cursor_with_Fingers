...
blue_range = np.array([[88,106,20],[128,255,255]])
yellow_range = np.array([[10,164,50],[61,255,255]])
red_range = np.array([[126,141,38],[180 ,255,255]])
...
cv2.namedWindow('PyPower Project - Mouse Handling')
...
while(1):
	...
	cv2.imshow('PyPower Project - Mouse Handling', frame)
